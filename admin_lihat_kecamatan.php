...
From kecamatan Inner Join
  provinsi On kecamatan.ID_PROVINSI = provinsi.ID_PROVINSI ORDER BY ID_KECAMATAN desc $limit ";

 $textline1="Total Kecamatan : $rows";
								...
								$list.= "<table class='table table-striped' >";
									$list.= "<tr>
										...
										while($row=$result->fetch_assoc())
										{
											...
											$list.="<tr>";
												$list.= "<td>$i</td>";
												$list.= "<td>".$row["NAMA_PROVINSI"]."</td>";
												$list.= "<td>".$row["NAMA_KECAMATAN"]."</td>";
												$list.= "<td><a href='admin_hapus_kecamatan.php?id=".$row["ID_KECAMATAN"]."' class='btn btn-danger btn-sm'><i class='fa fa-trash'></i></a></td>";
											$list.="</tr>";
										}
								$list.= "</table>";
						}
...
<div class="container">
	<div class="row">
		...
		<div class="col-sm-9" >
			<h3><i class="fa fa-bank"></i> Detail Kecamatan </h3><hr>    
