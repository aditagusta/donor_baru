...
$sql="SELECT * FROM provinsi  $limit ";

 $textline1="Total Provinsi : $rows";
									...
									$list.= "<tr>
										...
										while($row=$result->fetch_assoc())
										{
											...
											$list.="<tr>";
												...
												$list.= "<td><a href='admin_hapus_provinsi.php?id=".$row["ID_PROVINSI"]."' class='btn btn-danger btn-sm'><i class='fa fa-trash'></i></a></td>";
											$list.="</tr>";
										}
								$list.= "</table>";
						}
...
<div class="container">
	<div class="row">
		...
		<div class="col-sm-9" >
			<h3><i class="fa fa-bank"></i> Detail Provinsi </h3><hr>    
