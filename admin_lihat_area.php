...
$sql="Select kecamatan.NAMA_KECAMATAN, area.NAMA_AREA, area.ID_AREA
From area Inner Join
  kecamatan On area.ID_KECAMATAN = kecamatan.ID_KECAMATAN $limit ";
									...
									$list.= "<tr>
										...
										while($row=$result->fetch_assoc())
										{
											...
											$list.="<tr>";
												...
												$list.= "<td>".$row["NAMA_AREA"]."</td>";
												$list.= "<td><a href='admin_hapus_area.php?id=".$row["ID_AREA"]."' class='btn btn-danger btn-sm'><i class='fa fa-trash'></i></a></td>";
											$list.="</tr>";
										}
								$list.= "</table>";
						}
...
<div class="container">
	<div class="row">
		...
		<div class="col-sm-9" >
			<h3><i class="fa fa-bank"></i> Detail Area </h3><hr>    
